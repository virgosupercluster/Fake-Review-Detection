...
public final class listofreports_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(Utility.parse(request.getParameter("no"))==0)
	{
      ...
      out.write("\t    \r\n");
      out.write("\t    <h2 align=\"center\"><font color=\"black\"  size=\"6\">List of Reports</font></h2>\r\n");
      out.write("\t    \r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Report?no=1\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t<h3>One user - One Product</h3>\r\n");
      out.write("\t\t\t\t   </a></li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Report?no=2\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t<h3>One Product - All User</h3>\r\n");
      out.write("\t\t\t\t   </a></li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Report?no=3\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t<h3>One User - All Product</h3>\r\n");
      out.write("\t\t\t\t   </a></li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Report?no=4\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t<h3>Fake Reviews By all Users</h3>\r\n");
      out.write("\t\t\t\t   </a></li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Report?no=5\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t<h3>Meta Data Fake Review</h3>\r\n");
      out.write("\t\t\t\t   </a></li>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<p>Excel Uploaded Successfully....!</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t");
	...
	if(Utility.parse(request.getParameter("no1"))==2)
	{
      ...
      out.write("\t\t\t\t<p>Sorry!!! Excel Uploaded Failure....!</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t");
	...
	if(Utility.parse(request.getParameter("no"))==2)
	{
      ...
      out.write("\t\t<table id=\"login\" align=\"center\">\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    <h2 align=\"center\"><font color=\"black\"  size=\"6\">List of Graphs</font></h2>\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t\t<hr size=\"2\" color=\"#11F260\"></hr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/ViewGraph?no=2\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t\t<h3>Pie Chart of the  reviews</h3>\r\n");
      out.write("\t\t\t\t\t   </a>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/ViewGraph?no=3\" target=\"myIframe\">\r\n");
      out.write("\t\t\t\t\t<h3>Bar Chart Of the Product reviews </h3>\r\n");
      out.write("\t\t\t\t\t   </a>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
