...
class TextSearch 
{
	...
	public static String text_Search_content(String content)
	{
	...
	public static ArrayList text_filter(String original,String review_slno)
	{
		...
		for(int i=0;i<s.length;i++)
		{
			...
			if(s[i].trim()!=null)
			{
				...
				for(int j=0;j<word.length;j++)
				{
					...
					boolean f = AdminDAO.checkUnneccessary(search,review_slno);
