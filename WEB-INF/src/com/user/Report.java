		   ...
		   boolean	flag1=false;
			...
			else
			{
				...
				if(no==0)
				{
		     	...
		     	rd=request.getRequestDispatcher("/Files/JSP/User/listofreports.jsp");
				...
				else if(no==1)
				{
					...
					rd=request.getRequestDispatcher("/Files/JSP/User/choosereporttype.jsp?no=0");
					rd.forward(request,response);
				...
				else if(no==2)
				{
                 System.out.println("=========INSIDE NO=1====");
					...
					rd=request.getRequestDispatcher("/Files/JSP/User/choosereporttype.jsp?no=1");
					rd.forward(request,response);
				}
				else if(no==3)
				{
					 System.out.println("=========INSIDE NO=1====");
						...
						rd=request.getRequestDispatcher("/Files/JSP/User/choosereporttype.jsp?no=2");
						rd.forward(request,response);
				}
				else if(no==4)
				{
					...
					rd=request.getRequestDispatcher("/Files/JSP/User/reportgeneration.jsp?no=3");
					rd.forward(request,response);
				}
				else if(no==5)
				{

					rd=request.getRequestDispatcher("/Files/JSP/User/choosereporttype.jsp?no=5");
					rd.forward(request,response);
				}
