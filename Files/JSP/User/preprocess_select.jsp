...
<div  style="position:absolute;top:50px; height:300px; width:500px; background-color: white"  >
	<form name="f1" action="<%=request.getContextPath()%>/Preprocessingdata" method="get" >
	<table id="login" align="center">
	    
	    <h2 align="center"><font color="black"  size="6">Enter Your Keyword for Preprocessing</font></h2>
		...
		<tr id="label" align="center">
			...
			Enter Keyword:<input type="text"  name="preprocess"  required="required" width="200px"></input>
		...
		<tr align="center">
			<td align="center" colspan="3">
					<input type="submit" class="gradientbuttons" value="Preprocess" onclick="return check();"></input>
			</td>
	    </tr>
		...
		if(Utility.parse(request.getParameter("no1"))==1)
		{
			%>
				<div class="success" id="message" style="position:absolute;top:100px;left:200px">	
					<p>Preprocessing of data done successfully</p>
				</div>
			<%
		}
