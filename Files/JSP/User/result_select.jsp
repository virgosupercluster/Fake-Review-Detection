...
<div  style="position:absolute;top:50px; height:300px; width:500px; background-color: white"  >
	<form name="f1" action="<%=request.getContextPath()%>/Files/JSP/User/detectedsentiment.jsp" >
	
	<table id="login" align="center">
	    
	    <h2 align="center"><font color="black"  size="6">Select Your Topic to View Result</font></h2>
		...
		<tr id="label" align="center">
			...
			Enter Keyword:
			 <select name="resultprcs" id="resultprcs"   required>
		...
		<tr align="center">
			<td align="center" colspan="3">
					<input type="submit" class="gradientbuttons" value="ResultProcess" onclick="return check();"></input>
			</td>
	    </tr>
