...
<div  style="position:absolute;top:50px; height:300px; width:500px; background-color: white"  >
	<form name="f1" action="<%=request.getContextPath()%>/Sentimentprocess" method="get" >
	
	<table id="login" align="center">
	    
	    <h2 align="center"><font color="black"  size="6">Select Your Topic for Sentiment Process</font></h2>
		...
		<tr align="center">
			<td align="center" colspan="3">
					<input type="submit" class="gradientbuttons" value="SentimentProcess" onclick="return check();"></input>
			</td>
	    </tr>
