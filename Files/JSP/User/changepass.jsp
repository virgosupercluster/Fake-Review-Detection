...
<%
    ...
    if(Utility.parse(request.getParameter("no"))==0)
	{
    	...
    	System.out.println("=============Changepass========"+uname);
    	
%>

<div  style="position:absolute;top:50px; height:300px; width:500px; background-color: white"  >
	<form name="f1" action="<%=request.getContextPath()%>/ChangePass" method="get" >
	<table id="login" align="center">
	    
	    <h2 align="center"><font color="black"  size="6">Change Password</font></h2>
		...
		<tr id="label" align="center">
			...
			UserID:<input type="text"  name="userid" value="<%=uname%>" required="required" width="200px"></input>
		...
		<tr id="label" align="center">
			...
			Old Password:<input type="text"  name="oldpass"  required="required" width="200px"></input>
		...
		<tr id="label" align="center">
			...
			New Password:<input type="text"  name="newpass"  required="required" width="200px"></input>
		...
		<tr id="label" align="center">
			...
			Confirm Password:<input type="text"  name="conpass"  required="required" width="200px"></input>
		...
		<tr align="center">
			<td align="center" colspan="3">
					<input type="submit" class="gradientbuttons" value="Changepass" onclick="return check();"></input>
			</td>
	    </tr>
	...
	if(Utility.parse(request.getParameter("no1"))==2)
	{
		%>
			<div class="error" id="message" style="position:absolute;top:300px;left:300px">	
				<p>Sorry!!! Confirm Password is not matching</p>
			</div>
		<%
	}
	...
	if(Utility.parse(request.getParameter("no1"))==3)
	{
		%>
			<div class="error" id="message" style="position:absolute;top:300px;left:300px">	
				<p>Sorry!!! Change Password Failed</p>
			</div>
		<%
	}
